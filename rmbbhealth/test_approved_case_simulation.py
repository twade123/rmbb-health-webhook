...
def test_approved_case_simulation():
    ...
    custom_fields_list.extend([
        ...
        {"id": "XQLSYwSOodHOBrqv8oz0", "value": "Case approved based on simulated approval status for wound calculation testing"},  # rmbb_current_decision_summary (preserve original purpose)
        ...
        # Note: Wound calculation summary (calculation_result['calculation_summary']) should go to a dedicated field if available
    ])
