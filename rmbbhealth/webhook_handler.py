    ...
    if any(trigger in determining_value for trigger in denial_triggers):
        ...
        if 'PRIMARY' in determining_field.upper():
            ...
            return {
                ...
                'workflow_tags': ['rmbb-secondary-approved']
            }
    ...
    try:
        ...
        ivr_tracking_update = {
            "customField": [
                ...
                {"id": "lek4SmWzewBgvrAXBLWy", "value": primary_insurance_status or ""},  # rmbb_primary_insurance_status
                {"id": "vnZmPnf00xi9ImOLxao9", "value": secondary_insurance_status or ""},  # rmbb_secondary_insurance_status
