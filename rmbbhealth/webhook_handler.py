...
def update_ghl_contact_direct(contact_id, location_id, sub_account_api_key, custom_fields_update):
    ...
    Args:
        ...
        custom_fields_update: Custom fields data in format {"customFields": [{"key": "field", "value": "val"}]}
...
def handle_rmbb_status_webhook():
    ...
    try:
        ...
        ivr_tracking_update = {
            "customFields": [
                # Workflow status - map to existing GHL custom fields
                {"key": "ivr_status", "value": "ivr_received"},
                {"key": "ivr_received_date", "value": datetime.now().isoformat()},
                {"key": "ivr_webhook_processed", "value": "true"},
                
                # Primary status fields from RMBB Health API - map to existing GHL custom fields
                {"key": "ivr_case_status", "value": case_status or ""},
                {"key": "ivr_external_status", "value": external_status or ""},
                {"key": "ivr_overall_result", "value": overall_insurance_result or ""},
                
                # Insurance-specific statuses - map to existing GHL custom fields
                {"key": "primary_insurance_status", "value": primary_insurance_status or ""},
                {"key": "ivr_secondary_insurance_status", "value": secondary_insurance_status or ""},
                {"key": "ivr_tertiary_insurance_status", "value": tertiary_insurance_status or ""},
                
                # Insurance results - map to existing GHL custom fields
                {"key": "ivr_primary_insurance_result", "value": primary_insurance_result or ""},
                {"key": "ivr_secondary_insurance_result", "value": secondary_insurance_result or ""},
