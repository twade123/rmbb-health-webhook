...
class GHLRMBBWorkflowHandler:
    ...
    def submit_to_rmbb_health(self, external_id, contact_id, location_id, patient_form_data):
        """
            ...
            try:
                ...
                if isinstance(case_response, dict) and 'id' in case_response:
                    ...
                    try:
                        ...
                        if provider_name and contact_id and location_id:
                            ...
                            print(f"⚠️ Missing provider_name, contact_id, or location_id for case mapping")
